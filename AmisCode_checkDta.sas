libname a1 'C:\Users\mk3961\Dropbox\MixturesWorkshop_Aug2018\fromAmi';

options nonotes;

**restart;
data pcbs; set a1.pcbs;
run;
...
proc means data = pcbs n nmiss min q1 mean median std q3 max;
var ridageyr;
*class age_cat;
run;
...
proc means data = pcbs nmiss min q1 mean median std q3 max;
var bmxbmi;
*class bmi_cat3;
run;
...
proc freq data=pcbs;
tables smokepackyrs / missing;
where studypop=1;
run;

proc freq data=pcbs;
tables smokepackyrs studypop/ missing;
run;
