...
# n-folds is set to a default of 10 for cv.glmnet
elastic = glmnet(x, y, penalty.factor = c(0, rep(1, ncol(x[,19:36]))), alpha = 0.5)
plot(elastic)
...
elastic.mod = glmnet(x, y, penalty.factor = c(0, rep(1, ncol(x[,19:36]))), alpha = 0.5, lambda = best_elambda)
