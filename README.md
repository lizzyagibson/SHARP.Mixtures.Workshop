...
*Important: Within the RStudio environment, go to Session > Set Working Directory > To Source File Location. This will ensure that the relative file paths work correctly. You may need to reset this depending on your subfolder location.*
