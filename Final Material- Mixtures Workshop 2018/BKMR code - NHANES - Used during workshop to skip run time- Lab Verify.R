...
setwd("/Users/bcoull/Dropbox/HSPH/Admin/AndreaP30/EAC2017/RunCode")
...
nhanes <- na.omit(read.csv("/Users/bcoull/Dropbox/MixturesWorkshop_Aug2018/Data/studypop.csv"))
...
load("/Users/bcoull/Dropbox/MixturesWorkshop_Aug2018/code/BKMR/bkmr_NHANES_gvs_knots100.RData")
...
summary(lm(lnLTL_z ~lnmixture_z[,15] + lnmixture_z[,10] + lnmixture_z[,11] + lnmixture_z[,15]:lnmixture_z[,10]+ + lnmixture_z[,15]:lnmixture_z[,11]+covariates))
