...
Mean for each chemical whitin the population
...
plot_chem_means %>% 
  ggplot(aes(x = chem, y = colMeans(log.x), fill = Group)) + geom_col() + theme_bw() + 
  theme(legend.position = "bottom", axis.text.x = element_text(angle = 90, hjust = 1)) +
  geom_hline(yintercept = 0, size = 0.2) +
  labs(title = "Chemical Means in the Population", x = "Chemicals",
       y = "Mean")
```
