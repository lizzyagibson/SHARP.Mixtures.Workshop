...
Percent_bt_k1 = paste(round(100*(km1000$betweenss/km1000$totss),1), "%", sep = "")
...
Combine clusters grouping with original data outcome and covariants

```{r}
clu.group <- Km2$ #cluster group
...
pop_pca <- as.tibble((cbind(pop_pca, x)))
```
Model with 2  as a categorical variable (assigned to factor with highest score).
