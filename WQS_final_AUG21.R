...
result1 = gwqs(log(TELOMEAN) ~ NULL, mix_name = mixture, data = dataset, q = 10, validation = 0.6, valid_var = NULL,
...
result2 = gwqs(log(TELOMEAN) ~ LBXWBCSI + LBXLYPCT + LBXMOPCT + LBXEOPCT + LBXBAPCT + LBXNEPCT + age_cent + age_sq + 
...
# blood data: LBXWBCSI LBXLYPCT LBXMOPCT LBXEOPCT LBXBAPCT LBXNEPCT
# demographics: age_cent age_sq race_cat bmi_cat3 ln_lbxcot edu_cat
result3 = gwqs(log(TELOMEAN) ~ LBXWBCSI + LBXLYPCT + LBXMOPCT + LBXEOPCT + LBXBAPCT + LBXNEPCT + age_cent + age_sq + 
                 race_cat + bmi_cat3 + ln_lbxcot + edu_cat, mix_name = mixture, data = dataset, q = 10, 
...
result4 = gwqs(log(TELOMEAN) ~ LBXWBCSI + LBXLYPCT + LBXMOPCT + LBXEOPCT + LBXBAPCT + LBXNEPCT + age_cent + age_sq + 
