...
#Need one period to run in console: "./"
#Or change file path to match your computer
pdf(file=paste0("../BKMR/", "univar_ex_" ,plot.name,".pdf"), width=15, height=15)
...
#Need one period to run in console: "./"
#Or change file path to match your computer
pdf(file=paste0("../BKMR/", "bivar_ex_",plot.name,".pdf"), width=30, height=30)
...
#Need one period to run in console: "./"
#Or change file path to match your computer
pdf(file=paste0("../BKMR/", "bivar_levels_ex_",plot.name,".pdf"), width=30, height=30)
...
#Need one period to run in console: "./"
#Or change file path to match your computer
pdf(file=paste0("../BKMR/", "overallrisks_ex_",plot.name,".pdf"), width=10, height=10)
...
#Need one period to run in console: "./"
#Or change file path to match your computer
pdf(file=paste0("../BKMR/", "singvar_ex_",plot.name,".pdf"), width=5, height=10)
