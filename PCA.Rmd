...
eigenvalues_ln <- matrix(pca.ln$sdev^2)
eigenvalues_ln <- cbind(1:18, eigenvalues_ln) 
colum_ln <- c("Principal Component", "Eigenvalues")
eigenvalues_raw <- kable(eigenvalues_ln, col.names = colum_ln)
eigenvalues_raw 
...
#Eigenvalues 
eigenvalues_raw <- matrix(pca.raw$sdev^2)
eigenvalues_raw <- cbind(1:18, eigenvalues_raw) 
colum_n <- c("Principal Component", "Eigenvalues")
eigenvalues_raw <- kable(eigenvalues_raw, col.names = colum_n)
eigenvalues_raw 
...
pve.ln <- pca.ln$sdev^2/sum(pca.ln$sdev^2) #log-transformed data
...
plot_loadings_pca %>% 
  ...
  labs(title = "Eigenvectors for First 4 Principle Components", x = "Chemicals",
       y = "Eigenvectors (unit normalized loadings)")
```
