...
confint(health_model_pca)


PCA_betas_confint <- as.data.frame(c(health_model_pca$coefficients["PC1"], health_model_hc3$coefficients["PC2"], health_model_hc3$coefficients["PC3"])) %>% rownames_to_column() %>% rename("variable" = 1) %>% rename("beta_value" = 2) %>% mutate('95%_CI' = c("0.007-0.101", "-0.002-0.069"),
