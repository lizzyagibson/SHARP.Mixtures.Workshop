...
pop_clus <- as.tibble((cbind(studypop, clu.group)))
...
```{r}
<<<<<<< HEAD
health_model_kmeans5 <- lm(I(log(telomean)) ~ as.factor(clu.group) +
...
>>>>>>> b727a89dd990c31c1456e3a269c31a4248b03b8e
...
```{r}
health_model_kmeans3 <- lm(logtelomean ~ as.factor(clu.group3) + age_cent + age_sq +
     lbxwbcsi + lbxlypct + lbxmopct + lbxnepct + lbxeopct + lbxbapct +
...
hc_health_3 <- as.tibble(cbind(studypop, hc.clusters.3))
table(hc.clusters.3)
```
