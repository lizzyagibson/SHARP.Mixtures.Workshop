...
```{r}
cormat <- round(cor(log.x, use = "pairwise.complete.obs", method = c("pearson")),2)
...
melted_cormat %>% 
 ...
 scale_fill_gradient2(low = "blue", high = "red", mid = "white", 
  ...
  scale_y_discrete(expand = c(0, 0)) + theme_test() +
  ...
  labs(x = "", y = "", title = "Correlation Heat Map of POPs") +
