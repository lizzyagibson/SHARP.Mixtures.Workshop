...
melted_cormat <- melted_cormat %>% 
  ...
  mutate(Var1 = fct_recode(Var1, "PCB 74" = "lbx074la.l2",
                               ...
                               "PCB 169" =  "lbxhxcla.l2",
                                "PCB 126" = "lbxpcbla.l2"),
         Var2 = fct_recode(Var2, "PCB 74" = "lbx074la.l2",
                                "PCB 99" = "lbx099la.l2",
                                "PCB 118" = "lbx118la.l2",
                                "PCB 138" = "lbx138la.l2",
                                "PCB 153" = "lbx153la.l2",
...
library(factoextra)
fviz_nbclust(log.x, kmeans, method = "wss") ###the loop below can quickly be perform using this function. Result is the same.
