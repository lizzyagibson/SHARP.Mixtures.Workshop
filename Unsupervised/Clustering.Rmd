...
Kmeans3_betas_confint <- as.data.frame(c(health_model_kmeans3$coefficients["clu.group31"], health_model_kmeans3$coefficients["clu.group32"])) %>% rownames_to_column() %>% rename("variable" = 1) %>% rename("beta" = 2)%>% mutate('95%CI' = c("0.033, 0.132", "0.016, 0.091"),
...
hc3_betas_confint <- as.data.frame(c(health_model_hc3$coefficients["hc.clusters.31"], health_model_hc3$coefficients["hc.clusters.32"])) %>% rownames_to_column() %>% rename("variable" = 1) %>% rename("beta" = 2) %>% mutate('95%CI' = c("0.007, 0.101", "-0.002, 0.069"),
...
save(summary_kmeans_hc, file = "summary_kmeans_hc.csv")
```
